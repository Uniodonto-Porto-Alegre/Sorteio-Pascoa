    ...
    async function carregarUsuarios() {
        try {
            ...
            if (usuarios) {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>
                            <span class="status-badge ${usuario.sorteado ? 'bg-sorteado' : 'bg-pendente'}">
                                ${usuario.sorteado ? 'Sorteou' : 'Pendente'}
                            </span>
                        </td>
                        <td>${usuario.sorteado ? (usuario.amigoSorteado || 'N/A') : '-'}</td>
                        <td>
                ...
                listaUsuarios.innerHTML = '<tr><td colspan="5" class="text-center">Nenhum usuário cadastrado</td></tr>';
            }
        } catch (error) {
